...
def get_numbers_ticket(min_val,max_val,quantity):
    if quantity <= 0:
        print ("Потрібно задати кількість чисел")
    elif max_val<=min_val:
        print ("Спочатку вводимо менше число а потім більше")
    elif quantity > (max_val - min_val + 1):
        print ("Кількість чисел для генерації не може бути більшим за діапазон")
    else:
